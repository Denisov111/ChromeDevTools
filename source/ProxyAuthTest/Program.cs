        ...
        static void Main(string[] args)
        {
            Task.Run(async () =>
            {
                ...
                using (var chromeProcess = chromeProcessFactory.Create(9256, true))
                {
                    ...
                    //cookies
                    var ccs = await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.GetAllCookiesCommand());
                    ...
                    //enable network
                    var enableNetwork = await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.EnableCommand());
                    ...
                    var it = chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Input.InsertTextCommand
                    {
                    ...
                    var itPwd = chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Input.InsertTextCommand
                    {
                        Text = "qwerty"
                    });
                    ...
                    try
                    {
                        var click = chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Input.DispatchMouseEventCommand
                        {
                            Type = "mousePressed",
                            X = x,
                            Y = y,
                        ...
                        var clickReleased = chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Input.DispatchMouseEventCommand
                        {
                            Type = "mouseReleased",
                            X = x,
                            Y = y,
                    ...
                    var scroll = chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Input.DispatchMouseEventCommand
                    {
                        Type = "mouseWheel",
                        X = x,
                        Y = y,
                    ...
                    //cookies
                    var cookies = (await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.GetAllCookiesCommand())).Result.Cookies;
                    ...
                    //delete cookies
                    await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.ClearBrowserCookiesCommand());


                    //check delete cookies
                    var cookiesForCheck = (await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.GetAllCookiesCommand())).Result.Cookies;
                    ...
                    List<MasterDevs.ChromeDevTools.Protocol.Chrome.Network.Cookie> cookiesList = new List<MasterDevs.ChromeDevTools.Protocol.Chrome.Network.Cookie>();
                    foreach (var cookie in ja)
                    {
                        ...
                        var setCookie = await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.SetCookieCommand
                        {
                    ...
                    var cookiesForCheck2 = (await chromeSession.SendAsync(new MasterDevs.ChromeDevTools.Protocol.Chrome.Network.GetAllCookiesCommand())).Result.Cookies;
